...
Q_INVOKABLE void Room::setItems()
{
    ...
    for (int i=0;i<prem;i++){
        ...
        if (number)
            m_items.push_back(new Armor(10,generateRandomNumber(50,550),generateRandomNumber(50,450)));
        else
            m_items.push_back(new Gun(10,generateRandomNumber(50,550),generateRandomNumber(50,450)));
    }
